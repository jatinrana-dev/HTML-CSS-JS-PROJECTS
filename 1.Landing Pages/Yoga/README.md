...
- **[Remix Icon](https://remixicon.com/)** — icon font library (via CDN) for the menu/close icons and social icons
...
5. The site will open at `http://127.0.0.1:5500/index.html` with auto-reload on save
